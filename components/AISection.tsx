...
const agentActivities = [
  { role: "receptionist", color: "bg-[#F0F7E8] text-[#5C8A3A]", message: "Booked 3 appointments and sent confirmation texts. Prior auth flagged for Mohamed Erdman." },
  { role: "scribe",       color: "bg-[#F5F0FA] text-[#6B4A8A]", message: "SOAP note ready for Dr. Chen's 1:30 PM visit. ICD-10 and CPT codes suggested." },
  { role: "coder",        color: "bg-[#EBF0FA] text-[#1A4FBF]", message: "3 claims coded and queued. Modifier missing on ENC-004, flagged before submission." },
  { role: "nurse",        color: "bg-[#EBF0FA] text-[#1A4FBF]", message: "8 patient follow-ups done. 1 abnormal result escalated to Dr. Chen." },
];
      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-14">
          ...
          <p className="text-lg text-[#4A5A7A] max-w-2xl mx-auto">
            Your AI staff handles reception, documentation, coding, and billing. Your team sees everything and acts on what matters.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-10 items-start">
          ...
          <div className="min-w-0">
            <h3 className="text-sm font-semibold text-[#5A6A8A] uppercase tracking-wider mb-4">
              Live Activity
            </h3>
            <div className="space-y-3">
              {agentActivities.map((activity, i) => (
                <div
                  key={i}
                  className="bg-white rounded-xl p-4 border border-[#E0E6F5] flex gap-3 items-start"
                >
                  <span className={`px-2 py-0.5 rounded-full text-xs font-semibold shrink-0 mt-0.5 ${activity.color}`}>
                    {activity.role}
                  </span>
            ...
            <div className="mt-4 bg-[#1A4FBF] rounded-xl p-5 text-white">
              <div className="text-xs font-semibold uppercase tracking-wider text-[#BDD0F5] mb-2">
                Why AI staff?
              </div>
              <p className="text-sm text-[#EBF0FA] leading-relaxed">
                Your AI staff doesn&apos;t just flag tasks, it completes them. Scheduling, documentation, coding, and billing, all done automatically on every visit.
              </p>
            </div>
          </div>
          ...
          <div className="min-w-0">
            ...
            <p className="text-xs text-[#7A8AAF] mt-2 text-center">
              Available anywhere in the platform via <kbd className="px-1 py-0.5 rounded bg-[#EBF0FA] text-[#4A5A7A] font-mono text-xs">⌘K</kbd>
            </p>
          </div>
        </div>
      </div>
